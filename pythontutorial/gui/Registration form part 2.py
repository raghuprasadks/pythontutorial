...
def database():
   ...
   cursor.execute('INSERT INTO Student (FullName,Email,Gender,country,Programming) VALUES(?,?,?,?,?)',(name1,email,gender,country,prog1))
   conn.commit()
   Fullname.set("")
   Email.set(" ")
   var.set("Male")
...
#var2= IntVar()
c1 =Checkbutton(root, text="java", variable=var1).place(x=235,y=330)

c2 =Checkbutton(root, text="python", variable=var2).place(x=290,y=330)
